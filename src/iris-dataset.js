...
// ######### TRAINING DATASET
	...
	train: [{
		label: 'Iris-setosa',
		data: [ 5.0,3.3,1.4,0.2 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.3,3.7,1.5,0.2 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.3,3.7,1.5,0.2 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.1,3.8,1.6,0.2 ]
	}, {
		label: 'Iris-setosa',
		data: [ 4.8,3.0,1.4,0.3 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.1,3.8,1.9,0.4 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.0,3.5,1.6,0.6 ]
	}, {
		label: 'Iris-setosa',
		data: [ 4.4,3.2,1.3,0.2 ]
	}, {
		label: 'Iris-setosa',
		data: [ 4.5,2.3,1.3,0.3 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.0,3.5,1.3,0.3 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.1,3.4,1.5,0.2 ]
	}, {
		label: 'Iris-setosa',
		data: [ 4.4,3.0,1.3,0.2 ]
	}, {
		label: 'Iris-setosa',
		data: [ 4.9,3.1,1.5,0.1 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.5,3.5,1.3,0.2 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.0,3.2,1.2,0.2 ]
	}, {
		label: 'Iris-setosa',
		data: [ 4.9,3.1,1.5,0.1 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.5,4.2,1.4,0.2 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.2,4.1,1.5,0.1 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.4,3.4,1.5,0.4 ]
	}, {
		label: 'Iris-setosa',
		data: [ 4.8,3.1,1.6,0.2 ]
	}, {
		label: 'Iris-setosa',
		...
		label: 'Iris-setosa',
		data: [ 5.2,3.5,1.5,0.2 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.0,3.4,1.6,0.4 ]
	}, {
		label: 'Iris-setosa',
		data: [ 5.0,3.0,1.6,0.2 ]
	},


	{
		label: 'Iris-versicolor',
		data: [ 5.7,2.8,4.1,1.3 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.1,2.5,3.0,1.1 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 6.2,2.9,4.3,1.3 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.7,2.9,4.2,1.3 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.7,3.0,4.2,1.2 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.6,2.7,4.2,1.3 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.0,2.3,3.3,1.0 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.8,2.6,4.0,1.2 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 6.1,3.0,4.6,1.4 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.5,2.6,4.4,1.2 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.5,2.5,4.0,1.3 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.6,3.0,4.1,1.3 ]
	}, {
		label: 'Iris-versicolor',
		...
		label: 'Iris-versicolor',
		data: [ 6.0,2.7,5.1,1.6 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.8,2.7,3.9,1.2 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.5,2.4,3.7,1.0 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.5,2.4,3.8,1.1 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.7,2.6,3.5,1.0 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 6.0,2.9,4.5,1.5 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 6.7,3.0,5.0,1.7 ]
	}, {
		label: 'Iris-versicolor',
...

	{
		...
		label: 'Iris-virginica',
		data: [ 6.0,3.0,4.8,1.8 ]
	}, {
		label: 'Iris-virginica',
		data: [ 6.4,3.1,5.5,1.8 ]
	}, {
		label: 'Iris-virginica',
		data: [ 6.3,3.4,5.6,2.4 ]
	}, {
		label: 'Iris-virginica',
		data: [ 7.7,3.0,6.1,2.3 ]
	}, {
		label: 'Iris-virginica',
		data: [ 6.1,2.6,5.6,1.4 ]
	}, {
		label: 'Iris-virginica',
		data: [ 6.3,2.8,5.1,1.5 ]
	}, {
		label: 'Iris-virginica',
		data: [ 6.4,2.8,5.6,2.2 ]
	}, {
		label: 'Iris-virginica',
		data: [ 7.9,3.8,6.4,2.0 ]
	}, {
		label: 'Iris-virginica',
		...
		label: 'Iris-virginica',
		data: [ 6.4,2.8,5.6,2.1 ]
	}, {
		label: 'Iris-virginica',
		data: [ 6.1,3.0,4.9,1.8 ]
	}, {
		label: 'Iris-virginica',
		data: [ 6.2,2.8,4.8,1.8 ]
	}, {
		label: 'Iris-virginica',
		data: [ 7.2,3.2,6.0,1.8 ]
	}],
...
// ######### TESTING DATASET
...

	{
		...
		label: 'Iris-versicolor',
		data: [ 6.3,2.5,4.9,1.5 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 6.1,2.8,4.0,1.3 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.9,3.2,4.8,1.8 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.6,2.5,3.9,1.1 ]
	}, {
		label: 'Iris-versicolor',
		...
		label: 'Iris-versicolor',
		data: [ 5.6,3.0,4.5,1.5 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 6.7,3.1,4.4,1.4 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.6,2.9,3.6,1.3 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 6.1,2.9,4.7,1.4 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 6.0,2.2,4.0,1.0 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.9,3.0,4.2,1.5 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.0,2.0,3.5,1.0 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 5.2,2.7,3.9,1.4 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 6.6,2.9,4.6,1.3 ]
	}, {
		label: 'Iris-versicolor',
		...
		label: 'Iris-versicolor',
		data: [ 5.7,2.8,4.5,1.3 ]
	}, {
		label: 'Iris-versicolor',
		data: [ 6.5,2.8,4.6,1.5 ]
	}, {
		label: 'Iris-versicolor',
...

	{
		...
		label: 'Iris-virginica',
		data: [ 6.0,2.2,5.0,1.5 ]
	}, {
		label: 'Iris-virginica',
		data: [ 7.7,2.6,6.9,2.3 ]
	}, {
		label: 'Iris-virginica',
		data: [ 7.7,3.8,6.7,2.2 ]
	}, {
		label: 'Iris-virginica',
		...
		label: 'Iris-virginica',
		data: [ 7.2,3.6,6.1,2.5 ]
	}, {
		label: 'Iris-virginica',
		data: [ 6.7,2.5,5.8,1.8 ]
	}, {
		label: 'Iris-virginica',
